...
export default function EditExpenseScreen() {
  ...
  useEffect(() => {
    ...
    if (params.createdAt) setCreatedAt(params.createdAt as string);
  }, [params]);
  ...
  const handleSave = () => {
    ...
    // TODO: Cập nhật chi tiêu trong database
    console.log({
      id: params.id,
      title: title.trim(),
    ...
    Alert.alert(
      ...
      [
        { text: 'Hủy', style: 'cancel' },
        {
          ...
          style: 'destructive',
          onPress: () => {
            // TODO: Xóa chi tiêu (chuyển vào thùng rác)
            console.log('Xóa chi tiêu có ID:', params.id);
            Alert.alert('Đã xóa', 'Chi tiêu đã được chuyển vào thùng rác', [
              { text: 'OK', onPress: () => router.back() }
            ]);
          }
        }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.inputGroup}>
          <Text style={styles.label}>Tên khoản chi <Text style={styles.required}>*</Text></Text>
          <TextInput
            style={styles.input}
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.saveButton} onPress={handleSave}>
          <Text style={styles.saveButtonText}>Cập Nhật Chi Tiêu</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
